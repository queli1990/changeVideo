...
- (void)configurePropertys {
    ...
    _selectedTextFont = [UIFont fontWithName:@"Helvetica-Bold" size:17];
    _normalTextColor = [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:0.6];
    _selectedTextColor = [UIColor colorWithRed:((float)((0x0BBF06 & 0xFF0000) >> 16))/255.0 green:((float)((0x0BBF06 & 0xFF00) >> 8))/255.0 blue:((float)(0x0BBF06 & 0xFF))/255.0 alpha:1.0];
