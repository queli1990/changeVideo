...
- (void)addUnderLineView {
    ...
    progressView.backgroundColor = [UIColor colorWithRed:((float)((0x0BBF06 & 0xFF0000) >> 16))/255.0 green:((float)((0x0BBF06 & 0xFF00) >> 8))/255.0 blue:((float)(0x0BBF06 & 0xFF))/255.0 alpha:1.0];
